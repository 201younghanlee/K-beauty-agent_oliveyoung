...
Retailer product-name search links are generated by the application at runtime,
not stored as Open Beauty Facts evidence. They provide additional places to
check a product but do not prove an exact listing, current sale, price, or stock.
